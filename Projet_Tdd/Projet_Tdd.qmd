...
![Menu permettant le choix du sport](images/1er_menu.png){width=100%}

Prenons l'exemple du tennis, l'utilisateur a maintenant le choix entre le circuit ATP et WTA


![Menu permettant le choix du circuit](~/Projet_TDD/projetTDD_2026_structure/Projet_Tdd/images/1er_menu_tennis.png){width=100%, height=10cm}
...
![Carte de Jannik Sinner](~/Projet_TDD/projetTDD_2026_structure/Projet_Tdd/images/carte_joueur.png){width=100%, height=10cm}
